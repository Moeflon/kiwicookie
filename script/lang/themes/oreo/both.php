...
<hr/>
<div style="border: none; border-bottom: solid 1px rgba(0,0,0,0.2); margin-bottom:27px;"></div>
<h2 style="margin-top: -10px" id="installation">Deze site gebruikt cookies</h2>

<p>Om deze website goed te laten werken onze website te kunnen optimaliseren op uw beleving plaatsen wij kleine bestanden op uw computer (zogenaamde cookies) en analyseren wij het websitegebruik. Een zeer groot deel van de websites doen dit. Nieuwe wetgeving verplicht ons u hiervoor toestemming te vragen. U kunt <a href="#privacy_nl" onClick="show_nl()">hier</a> lezen hoe wij met uw privacy omgaan en <a href="#cookies_nl" onClick="show_nl()">hier</a> kunt u meer informatie vinden over cookies.</p>
<hr/>
...
<div id="privacy_en">
	...
	<h3 style="margin-bottom:-10px;">What do we use your personal data for?</h3>
		...
		In order for this site to work properly, and in order to evaluate and improve this site we need to store small files (the so-called cookies) on your computer and analyze your website usage. The majority of all website do this, however, Dutch laws require us to obtain your constent first. More detailed information about cookies and how we deal with them can be found in our <a href="#cookies_en">cookie statement</a>.
...
<div id="privacy_nl">
	...
	Onze website slaat persoonsgegevens zoals naam, e-mailadres en IP op. Wij vinden privacy erg belangrijk en zullen nooit persoonsgegevens anders gebruiken dan voor het aangegeven doel. Deze doelen vind u hieronder:<br/><br/>
	
	<h3 style="margin-bottom:-10px;">Waar gebruiken wij uw persoonsgegevens voor?</h3>
		<h4 style="margin-bottom: -3px; margin-top: 10px;">Registratie</h4>
		...
		<h4 style="margin-bottom: -3px; margin-top: 10px;">Communicatie</h4>
		...
		<h4 style="margin-bottom: -3px; margin-top: 10px;">Websitegebruik</h4>
		...
		<h4 style="margin-bottom: -3px; margin-top: 10px;">Nieuwsbrief</h4>
		...
		<h4 style="margin-bottom: -3px; margin-top: 10px;">Advertenties</h4>
		...
		<h4 style="margin-bottom: -3px; margin-top: 10px;">Sociale netwerken</h4>
...
<div id="cookies_nl">
	<h2 style="margin-top: 15px;">Cookies</h2>
		<h4 style="margin-bottom: -3px; margin-top: 10px;">Wat zijn cookies?</h4>
		Cookies zijn kleine bestanden die op uw computer worden opgeslagen.
				
		<h4 style="margin-bottom: -3px; margin-top: 10px;">Waar kunnen cookies voor worden gebruikt?</h4>
		...
		<h4 style="margin-bottom: -3px; margin-top: 10px;">Waar gebruiken wij cookies voor, en welke diensten gebruiken wij?</h4>
			<ul>
