  ...
  <body>
    <div class="wrapper">
     ...
     <?php endif; ?>
      ...
      <!-- oreo -->
        <div id="image" style="background: url('http://f.cl.ly/items/2e0e2x3Y1c3j180c0v3R/image.png'); height: 140px; width: 186px; margin: 0 auto; margin-top: -115px; opacity: 0.8;">
        </div>
      <!-- oreo -->
        

<h2><?php echo WARNING_TITLE1; ?></h2>
...
<?php else: ?>
	...
	<div id="bottomhr" style="background: url('http://kiwiboom.github.com/kiwicookie/images/hr.gif');border: 0;height: 11px;margin-bottom:0px;">
	</div>
<?php endif; ?>
