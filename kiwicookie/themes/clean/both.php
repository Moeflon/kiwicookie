...
<head>
	...
	<script>
		...
		function show_en(elm) {
			$('#'+elm).fadeIn('slow');
		}
		
		function hide_en(elm) {
			$('#'+elm).fadeOut('slow');
		}
		
		function show_nl(elm) {
			$('#'+elm).fadeIn('slow');
		}
		
		function hide_nl(elm) {
			$('#'+elm).fadeOut('slow');
		}
	</script>
</head>
<body>
	<!-- English -->
	<h1><?php echo EN_WARNING_TITLE1; ?></h1>
	<div class="info">
	...
	<hr/>
	<!-- Dutch -->
	<h1><?php echo NL_WARNING_TITLE1; ?></h1>
	<div class="info">
	...
	<div id="privacy_nl">
		<h1><?php echo NL_PRIVACY_TITLE1; ?></h1>
		<div class="info" style="font-size:13px;">
			<?php echo NL_PRIVACY_P1; ?>		
			<h3><?php echo NL_PRIVACY_TITLE2; ?></h3>
			<h5><?php echo NL_PRIVACY_TITLE3; ?></h5>
			<?php echo NL_PRIVACY_P3; ?>		
			<h5><?php echo NL_PRIVACY_TITLE4; ?></h5>
			<?php echo NL_PRIVACY_P4; ?>			
			<h5><?php echo NL_PRIVACY_TITLE5; ?></h5>
			<?php echo NL_PRIVACY_P5; ?>			
			<h5><?php echo NL_PRIVACY_TITLE6; ?></h5>
			<?php echo NL_PRIVACY_P6; ?>
			<h5><?php echo NL_PRIVACY_TITLE7; ?></h5>
			<?php echo NL_PRIVACY_P7; ?>		
			<h5><?php echo NL_PRIVACY_TITLE8; ?></h5>
			<?php echo NL_PRIVACY_P8; ?>			
			<h3><?php echo NL_PRIVACY_TITLE9; ?></h3>
			<?php echo NL_PRIVACY_P9; ?>
			<h3><?php echo NL_PRIVACY_TITLE10; ?></h3>
			<?php echo NL_PRIVACY_P10; ?>		
			<h3><?php echo NL_PRIVACY_TITLE11; ?></h3>
			<?php echo NL_PRIVACY_P11; ?>
			<div style="height: 5px;"></div>
			<button onClick="hide('privacy_nl')">Verberg/Hide</button>
		</div>
	</div>

	<div id="cookies_nl">
		<h1><?php echo NL_COOKIES_TITLE1; ?></h1>
		<div class="info" style="font-size:13px;">
			<h3><?php echo NL_COOKIES_TITLE2; ?></h3>
			<?php echo NL_COOKIES_P2; ?> 
			
			<h3><?php echo NL_COOKIES_TITLE3; ?></h3>
			...
			<h3><?php echo NL_COOKIES_TITLE4; ?></h3>
				<ul>
			...
			<h3><?php echo NL_COOKIES_TITLE5; ?></h3>
			<?php echo NL_COOKIES_P5; ?>		
			<div style="height: 5px;"></div>
			<button onClick="hide('cookies_nl')">Verberg/Hide</button>
		</div>
	</div>

	<div id="privacy_en">
		<h1><?php echo EN_PRIVACY_TITLE1; ?></h1>
		<div class="info" style="font-size:13px;">
			<?php echo EN_PRIVACY_P1; ?>		
			<h3><?php echo EN_PRIVACY_TITLE2; ?></h3>
			<h5><?php echo EN_PRIVACY_TITLE3; ?></h5>
			<?php echo EN_PRIVACY_P3; ?>		
			<h5><?php echo EN_PRIVACY_TITLE4; ?></h5>
			<?php echo EN_PRIVACY_P4; ?>			
			<h5><?php echo EN_PRIVACY_TITLE5; ?></h5>
			<?php echo EN_PRIVACY_P5; ?>			
			<h5><?php echo EN_PRIVACY_TITLE6; ?></h5>
			<?php echo EN_PRIVACY_P6; ?>
			<h5><?php echo EN_PRIVACY_TITLE7; ?></h5>
			<?php echo EN_PRIVACY_P7; ?>		
			<h5><?php echo EN_PRIVACY_TITLE8; ?></h5>
			<?php echo EN_PRIVACY_P8; ?>			
			<h3><?php echo EN_PRIVACY_TITLE9; ?></h3>
			<?php echo EN_PRIVACY_P9; ?>
			<h3><?php echo EN_PRIVACY_TITLE10; ?></h3>
			<?php echo EN_PRIVACY_P10; ?>		
			<h3><?php echo EN_PRIVACY_TITLE11; ?></h3>
			<?php echo EN_PRIVACY_P11; ?>
			<div style="height: 5px;"></div>
			<button onClick="hide('privacy_en')">Verberg/Hide</button>
		</div>
	</div>

	<div id="cookies_en">
		<h1><?php echo EN_COOKIES_TITLE1; ?></h1>
		<div class="info" style="font-size:13px;">
			<h3><?php echo EN_COOKIES_TITLE2; ?></h3>
			<?php echo EN_COOKIES_P2; ?> 
			
			<h3><?php echo EN_COOKIES_TITLE3; ?></h3>
			...
			<h3><?php echo EN_COOKIES_TITLE4; ?></h3>
				<ul>
			...
			<h3><?php echo EN_COOKIES_TITLE5; ?></h3>
			<?php echo EN_COOKIES_P5; ?>		
			<div style="height: 5px;"></div>
			<button onClick="hide('cookies_en')">Verberg/Hide</button>
		</div>
	</div>
</body>
</html>